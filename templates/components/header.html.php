<header>
    ...
    <div id="searchForm">
        <input type="text" id="searchInput" placeholder="Chercher..." value="<?php if(isset($search)){echo $search;}?>">
    ...
    <div id="user">
        ...
        <svg onclick="redirect('controller=Cart&task=index')" class="icon" viewBox="0 0 576 512">
            <g class="fa-group">
