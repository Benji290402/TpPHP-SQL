        ...
        <div id="topRight">
            <?php if(isset($_SESSION['user'])){ ?>
                <?php if($_SESSION['user']['img']){?>
                    <img class="avatar" src="<?=$_SESSION['user']['img']?>" alt="avatar" onclick="window.location.href='index.php?controller=users&task=mypage'">
                <?php }else{?>
                    <svg class="avatar" viewBox="0 0 496 512" onclick="window.location.href='index.php?controller=users&task=myPage'">
                        <g>
